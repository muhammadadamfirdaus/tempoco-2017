...
<meta property="og:title" content="TEMPO.CO" />
...
<meta name="twitter:title" content="TEMPO.CO" />
	...
	<main>
										...
										<div class="card card-type-1">
											<div class="wrapper clearfix">
												...
												<a class="col" href="#">
													...
													<span class="col time">180k dilihat</span>
												</a>
											</div>
										</div>
									</li>
										...
										<div class="card card-type-1">
											<div class="wrapper clearfix">
												...
												<a class="col" href="#">
													...
													<span class="col time">Senin, 05 Desember 2016</span>
												</a>
											</div>
										</div>
									</li>
				...
				<div class="col w-30">
					...
					<section id="update" class="list list-type-1">
						<div class="wrapper">
							...
							<a href="#" class="box-title selengkapnya">
								Selengkapnya
							</a>
							<!-- end terbaru -->
						</div>
			...
			<section id="section-3" class="kanal-pilihan">
				<div class="wrapper clearfix">
					<div id="bisnis" class="col w-30">
						<div class="wrapper">
							<a href="#bisnis-1" class="box-title red-500 current">Bisnis</a>
							<li>
								<div class="card card-type-1">
									<div class="wrapper clearfix">
										<a class="col" href="#">
					...
					<div id="cantik" class="col w-30">
						<div class="wrapper">
							<a href="#cantik-1" class="box-title red-500 current">Cantik</a>
							<li>
								<div class="card card-type-1">
									<div class="wrapper clearfix">
										<a class="col" href="#">
					...
					<div id="otomotif" class="col w-30">
						<div class="wrapper">
							<a href="#otomotif-1" class="box-title red-500 current">Otomotif</a>
							<li>
								<div class="card card-type-1">
									<div class="wrapper clearfix">
										<a class="col" href="#">
		...
		<div class="container-desktop">
			<section id="section-5" class="clearfix">
				...
				<div class="col w-30">
					<section id="update" class="list list-type-2 tempo-channel clearfix">
						<div class="wrapper">
							...
							<li>
								<div class="card card-type-1">
									<div class="wrapper clearfix">
										...
										<a class="col" href="#">
											<h2 class="title">Setahun Terakhir, Penduduk Depok Bertambah 47 Ribu</h2>
											<span class="col time">Muhammad Adam Firdaus</span>
										</a>
									</div>
								</div>
							</li>
